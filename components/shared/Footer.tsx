  ...
  return (
    <div className="max-w-7xl mx-auto px-4 min-h-scree py-10 flex items-center justify-center bg-black">
      <div className=" w-full px-4 text-white flex flex-col">
        <div className="w-full text-3xl md:text-5xl lg:text-7xl font-bold">
        ...
        <div className="flex mt-8 flex-col md:flex-row md:justify-between">
          ...
          <div className="w-44 pt-6 md:pt-0">
            <a className="bg-primary justify-center text-center rounded-lg shadow px-10 py-3 flex items-center">
              Contact US
            </a>
          </div>
        </div>
        <div className="flex flex-col">
          ...
          <p className="w-full text-center mt-12 text-gray-600">
            Copyright © 2024 techgear Creative
          </p>
        </div>
      </div>
    </div>
